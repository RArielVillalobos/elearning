...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password','last_name','slug','id_role'
    ];
    ...
    //el 2do argumento es la llave foranea del user, y el tercero la llave principal de la tabla role
    ...
    //el usuario va a tener una red social
